...
class phpML extends Controller {
    ...
    public function index(Request $request) {
        ...
        $checkedBox = $arr_bus[2] + $arr_food[2] + $arr_parking[2] + $arr_timeTable[2] + $arr_lecturer[2] + $arr_outdoor[2] + $arr_facility[2];
        $checkedBoxError = "Please check at least one box.";
        
        if ($checkedBox === 0) {
            return view('home')
                            ->with('checkedBoxError', $checkedBoxError);
        }
