...
<div style="width: 20%; height: 520px; border: 1px black solid; float: right; background-color: #343a40; overflow-y: auto;">
    <p style="color: blue; display: inline; border: 1px solid black">Analysis sources : {{$fileName}}</p>
